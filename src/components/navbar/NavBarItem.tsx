...
export const NavBarItem = (props: NavBarItemProps) => {
  ...
  if (!props.dropdown || !props.dropdownLinks) {
    ...
    return (
      <Menu as="div" className="relative inline-block text-left ml-[3vw]">
        <Menu.Button
          className={`bg-opacity-90 z-20 flex items-center space-x-4 font-inter font-thin text-[2vw] h-[3vw] my-[0.3vw] ${
            props.selected ? "text-[#FFC42D]" : "text-white"
          }`}
        >
          ...
          <svg
            ...
            viewBox="0 0 38 22"
            fill="none"
            className="transform ui-open:rotate-180 transition-transform duration-200"
          >
            <path
        ...
        <Menu.Items className="absolute left-0 mt-1 w-auto min-w-full bg-[#131313] rounded-md shadow-lg">
          {props.dropdownLinks.map((link) => (
            <Menu.Item key={link.href} as={Fragment}>
              {({ active }) => (
                <Link
                  to={link.href}
                  className={`block px-4 py-2 font-inter font-thin text-[1.5vw] ${
    ...
    //             viewBox="0 0 38 22"
    //             fill="none"
    //             className="ml-[0.6vw] ui-open:hidden"
    //           >
    //             <path
    ...
    //             viewBox="0 0 38 22"
    //             fill="none"
    //             className="ml-[0.6vw] ui-not-open:hidden"
    //           >
    //             <path
    //               d="M20.7678 1.23223C19.7915 0.255922 18.2085 0.255922 17.2322 1.23223L1.32233 17.1421C0.34602 18.1184 0.34602 19.7014 1.32233 20.6777C2.29864 21.654 3.88155 21.654 4.85786 20.6777L19 6.53553L33.1421 20.6777C34.1184 21.654 35.7014 21.654 36.6777 20.6777C37.654 19.7014 37.654 18.1184 36.6777 17.1421L20.7678 1.23223ZM21.5 4V3L16.5 3V4L21.5 4Z"
    //               fill={props.selected ? "#FFC42D" : "#FFFF"}
    //             />
    //           </svg>
    //         </div>
    ...
    //             <div
    //               className={classNames(
    //                 "w-[16vw] h-fit flex items-center mx-[-0.03vw]",
