  ...
  const content = (
    <div className="w-[175px] md:w-[400px] bg-[#D9D9D9] flex flex-col md:flex-row items-center rounded-lg h-full md:h-[80px] overflow-hidden">
      ...
      {(props.logo || props.secondLogo) && (
        <div className="hidden md:flex shrink-0 ml-2 -mr-2 my-2 md:my-0">
          {props.logo && (
            <img 
              src={props.logo} 
              alt={`${props.name} logo`} 
      ...
      <div>
        <div className="font-coolvetica text-lg leading-tight md:leading-none md:text-2xl px-4 py-2 md:py-0 truncate">
          {props.name}
        </div>
      </div>
    </div>
