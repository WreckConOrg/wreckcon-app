...
import SarahNicoleRobles from "./../../assets/guest_pictures/SarahNicoleRobles.jpg"
...
export const GUESTSCONFIG: GuestProps[] = [
  {
    name: "Tiffany Grant",
    bodyText: `Best known as Asuka from Evangelion, Tiffany's worked in anime since 1994. Her 1700+ anime credits include Blue Seed, Fairy Tail, Full Metal Alchemist, One Piece, Akame Ga Kill and Ushio &Tora. Recent projects include Neon Genesis Evangelion: Anima (SevenSeasAudiobooks.com). 
    
Select video games: Warframe, Neversong, Brawl Stars, Paladins, Smite and AFK Arena. Ms. Grant wrote English dubbing scripts for titles such as Tears to Tiara, Parasyte-the-Maxim & several subtitled scripts. Ms. Grant has also worked for many years in theatre, commercials and film.

See her on the main stage at our voice actor's panel "Tiffany Grant, Morgan Berry, Sarah-Nicole Robles, and Zach Pokres: Behind the Voices" at WreckCon 2026! She will be selling and signing merch throughout the day as well!`,
...
Catch her at our voice actor's panel ""Tiffany Grant, Morgan Berry, Sarah-Nicole Robles, and Zach Pokres: Behind the Voices" on the main stage! She will also be signing autographs and prints. `,
    picture: MorganBerry,
  },
  {
    name: "Sarah-Nicole Robles",
    bodyText: `Sarah-Nicole was born and raised in New Jersey. She left home to attend college at Carnegie Mellon University in Pittsburgh where she got her BFA in Acting. From there she moved to LA where she continued to pursue Acting. She is currently voicing Luz Noceda for Disney's The Owl House. She can also be heard on Nickelodeon's Billy Dilley's Super-Duper Subterranean Summer, Dreamworks' Boss Baby: Back in Business, Disney's Star Darlings and Olaf's Frozen Adventure. On camera she can also be seen on episodes of NCIS LA and Grey's Anatomy.  When she's not working she loves reading, baking, and horror movies.
    
Catch her at our voice acting panel "Tiffany Grant, Morgan Berry, Sarah-Nicole Robles, and Zach Pokres: Behind the Voices" on the main stage at WreckCon 2026! She will also be signing prints and selling merch throughout the day.`,
...
Catch him on the main stage at our voice actor's panel ""Tiffany Grant, Morgan Berry, Sarah-Nicole Robles, and Zach Pokres: Behind the Voices" at WreckCon 2026!`,
    picture: ZachPokres,
    role: "Voice Actor",
  },
//   {
