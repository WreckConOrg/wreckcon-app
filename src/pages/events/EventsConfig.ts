...
export const EVENTCONFIG: EventProps[] = [
  ...
  },
  {
    ...
    bodyText: `This is a chance for you to show off your cosplay crafting skills at WreckCon 2026! A panel of special guest cosplay judges will evaluate your cosplays and select 5 winners to take home a 4-day pass to MomoCon 2026!
    
Previous signup required. Up to 25 people will be selected to go through to day-of judging.`,
    link: "https://forms.gle/UHPEtavgD1oc7rcr9",
    buttonText: "Apply",
    picture: cosplay,
    location: "Main Stage",
  },
  {
    name: "Cosplay Aura Farming Tournament of Power",
    bodyText: `This is the event for you to show off both your cosplay and your performance. Anime O'Tekku officers will pick out 3 participants based on the cosplay, performance/skit, stage presence, and other factors, to receive 4-day passes to MomoCon 2026.
...
Signups will be open on the day of WreckCon 2026 at the link given here!`,
  ...
  {
    name: "Hopping Heart Idol Fest",
    bodyText: `Come and cheer on your favorite idols in our idolfest, hosted by GT's own idol group, Hachi☆Pop! Watch idols cosplay as the characters in their chosen songs or perform as their own original idols as all in the spotlight all will shine! Raise those penlights in the air as idol groups light the stage with performances from all different genres from Jpop, Vocaloid, rhythm games, anime and Kpop!`,
    picture: idolfest,
    location: "Main Stage",
  },
  {
